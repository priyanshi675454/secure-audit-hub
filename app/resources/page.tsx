...
export default function ResourcesPage() {
  ...
  const resources = [
    ...
    {
      id: 4,
      title: "Video: Application Process Walkthrough",
      description: "Watch our team walk through the entire subsidy application process from start to finish with real examples.",
      category: "videos",
      type: "Video",
      duration: "18 minutes",
      difficulty: "Beginner",
